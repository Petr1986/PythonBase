...
@pytest.mark.parametrize(
    ...
    [
        ((-97, 41), (31, 62), (44, -19), 5320.50),
        ((-46, 63), (71, 78), (79, -18), 5676.00),
        ((-100, 34), (99, 33), (3, -46), 7908.50),
    ],
)
...
@pytest.mark.parametrize(
    "p1, p2, p3",
    [((20, -35), (124, -23), (115, -122)), ((-164, 152), (-34, 194), (-141, 134))],
)
...
@pytest.mark.parametrize(
    "a, b, c, except_result",
    [
        ((-28, 95), (22, 67), (39, -67), 367.69),
        ((-54, 55), (81, 16), (2, -96), 438.63),
        ((-72, 5), (11, 37), (40, -88), 362.86),
    ],
)
