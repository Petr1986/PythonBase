...
@pytest.mark.parametrize("num1, num2, expected_result", [(94, -4, True), (11, -45, True), (-76, -76, False)])
...
@pytest.mark.parametrize('num1, num2, num3, expected_result', [(55, 58, 14, False), (71, 70, -14, True), (-9, 39, 5, False)])
def test_between_numbers(num1, num2, num3, expected_result):
    assert between_numbers(num1, num2, num3) == expected_result


@pytest.mark.parametrize('num1, num2, num3', [(-120, 80, 4), (-43, 254, 90), (56, -45, 3000)])
def test_between_numbers_out_of_range(num1, num2, num3):
    with pytest.raises(ValueError, match = 'out of range'):
        between_numbers(num1, num2, num3)


@pytest.mark.parametrize('num1, num2, expected_result', [(-2, -70, True), (-98, 1, False), (22, -15, False)])
...
@pytest.mark.parametrize('num1, num2, expected_result', [(8, 65, True), (87, -41, False), (-49, 3, False)])
