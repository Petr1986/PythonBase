...
@pytest.mark.parametrize("x, y, expected_result", [('288', '492', 2849), ('480', '443', 4844), ('764', '891', 7689)])
...
@pytest.mark.parametrize("num, k, m, expected_result", [(1, 3, 4, 3.246), (3, 3, 7, 128.877), (4, 2, 10, 20.047)])
...
@pytest.mark.parametrize("first_time, second_time, expected_result", [((2, 6, 39), (2, 50, 46), 2647), ((2, 7, 11), (2, 52, 59), 2748), ((2, 20, 25), (2, 53, 37), 1992)])
def test_find_time(first_time, second_time, expected_result):
    assert find_time(first_time, second_time) == expected_result

@pytest.mark.parametrize("first_time, second_time", [((3, 12, 64), (0, 8, 32)), ((23, 56, 8), (8, 94, 30)), ((18, 24, 30), (89, 34, 12))])
...
@pytest.mark.parametrize("wb, bb, expected_result", [(6, 7, 19.23), (10, 6, 37.5), (9, 8, 26.47)])
...
@pytest.mark.parametrize("sec, expected_result", [(9308, (155, 2, 8, 35)), (4250, (70, 1, 50, 10)), (6589, (109, 1, 49, 49))])
...
@pytest.mark.parametrize('degrees, minutes, seconds, expected_result', [(127, 49, 30, (2.23, 0.79, 0.61, -1.29)), (170, 3, 39, (2.97, 0.17, -0.98, -0.18)), (119, 39, 59, (2.09, 0.87, -0.49, -1.76))])
...
@pytest.mark.parametrize('degrees, minutes, seconds', [(190, 15, 36), (110, 67, 42), (30, 54, -10)])
